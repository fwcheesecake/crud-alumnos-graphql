...
export const resolvers = {
    Query: {
        getAllStudent: async (parent: Student,
            args: {},
    ...
    Mutation: {
        createStudent: async (parent: Student,
            args: {
                control: string;
                name: string;
                lastname1: string;
        ...
        deleteStudent:async (parent:Student, args:{control:string},
            context:GraphQLContext) => {
        ...
        updateStudent:async (parent:Student, args:{ 
            control: string;
            name: string;
            lastname1: string;
            lastname2: string;
            ...
            birthday: Date;
            student_state: StudentState;
            tutor_id: number}, context: GraphQLContext) => {  
